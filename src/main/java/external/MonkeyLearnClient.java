...
public class MonkeyLearnClient {
	private static final String API_KEY = "b31e030d805f5681cd6c30e1a91df6c49ec51665";// make sure change it to your api key.
       public static void main(String[] args) {
		
		String[] textList = {
				"Elon Musk has shared a photo of the spacesuit designed by SpaceX. This is the second image shared of the new design and the first to feature the spacesuit’s full-body look.", 
				"I love cooking and coding.",};
	...
	public static List<List<String>> extractKeywords(String[] text) {
		...
		// Use the API key from your account
				MonkeyLearn ml = new MonkeyLearn("b31e030d805f5681cd6c30e1a91df6c49ec51665");
